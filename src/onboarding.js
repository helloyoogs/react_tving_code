...
function onboarding() {
  let [faq_active, set_faq_active] = useState([" "]);
  let [header_active, set_header_active] = useState([" "]);
  let [wheel_active, set_wheel_active] = useState([" "]);

    /* wheel,scrtoll 이벤트 header */
    function scroll_slider(e) {
      const content_wrap1_height =
        document.querySelector(".content_wrap1").clientHeight;
      const content_wrap2_height =
        document.querySelector(".content_wrap2").clientHeight;
    ...
    <div className="onboarding">
        ...
        <div className="wheel_wrap">
          <ul className={'wheel_img '+ wheel_active}>
            <li className={'wheel_img_box ' + wheel_active}>
              <img src="img/P001587321.jpg" />
              <img src="img/F_webp,720_1.webp" />
            </li>
            <li className={'wheel_img_box ' + wheel_active}>
              <img src="img/P001613931.jpg" />
              <img src="img/F_webp,720_2.webp" />
            </li>
            <li className={'wheel_img_box ' + wheel_active}>
              <img src="img/P001594130.jpg" />
              <img src="img/F_webp,720_3.webp" />
            </li>
            <li className={'wheel_img_box ' + wheel_active}>
              <img src="img/P001616289.jpg" />
              <img src="img/F_webp,720_4.webp" />
            </li>
          </ul>
        </div>
      </div>
          ...
          <article class="wrapper">
            <div class="marquee">
              <div class="marquee__group">
                <img src="img/P001616584.webp" />
                <img src="img/P001624993.webp" />
                <img src="img/P001613931.webp" />
                <img src="img/P001602837.webp" />
                <img src="img/P001616345.webp" />
              </div>
            ...
            <div class="marquee marquee--reverse">
              <div class="marquee__group">
                <img src="img/P001619462.webp" />
                <img src="img/P001637397.webp" />
                <img src="img/P001635511.webp" />
                <img src="img/P001627603.webp" />
                <img src="img/P001635813.webp" />
              </div>
      ...
      <div className="content_wrap4">
        ...
        <div className="main_content_img">
          <video muted autoPlay loop src="img/smart_all.mp4"></video>
          <img src="img/quickss.png" />
        </div>
      </div>
      ...
      <div className="content_wrap5">
        ...
        <div className="main_content_img">
          <video muted autoPlay loop src="img/together_pc.mp4"></video>
        </div>
      </div>
      <div className="content_wrap6">
        <div className="main_content">
          <img src="img/tving-new-logo-pc.svg" />
          <p>지금 시작해보세요</p>
          <button>새로워진 티빙을 만나보세요!</button>
        </div>
      </div>
      <div className="content_wrap7">
        ...
        <li className="faq">
          ...
          {faq_active == "active0" ? (
            <div>
              ...
              <br />
              <br />■ 티빙 챗봇 이용 방법 안내
              <br />① PC 및 모바일에서 웹 브라우저 실행 (크롬, 사파리, 엣지 등)
        ...
        <li className="faq">
          ...
          {faq_active == "active2" ? (
            <div>
              ...
              <br />- CJ ONE 통합회원이신 경우 'CJ ONE으로 시작하기' 선택 (제일
              밑에 위치)
        ...
        <li className="faq">
          ...
          {faq_active == "active3" ? (
            <div>
              <div class="css-kg6wc6 e1bav4i39">
                <p class="css-14fewbl e1bav4i38">
                  <div>
                    ...
                    <br />
                    1) 베이직 이용권 <br />- 실시간 + TV프로그램 + 영화(개별구매
                    제외), 720p HD 화질 이용 가능 (모바일 + PC) <br />- 동시
                    시청 1명 <br />- (월간) 7,900원 / (연간) 71,000원&nbsp;
                    ...
                    화질(스마트TV 일부 콘텐츠 한정) 이용 가능 <br />- 동시 시청
                    4명 <br />- (월간) 13,900원 / (연간) 125,000원
                    <br />
                    ...
                    프로그램 + T ONLY 콘텐츠 시청, 720p HD 화질 이용 가능 <br />
                    - T ORIGINAL 콘텐츠, 파라마운트+ 콘텐츠, 월정액 영화
                    콘텐츠는 시청 불가
                    <br />- 동시 시청 1명
                    <br />* 네이버플러스 멤버십 이용권의 가격은 네이버의 정책을
                    따릅니다.
                  </div>
                </p>
              </div>
